...
<script type="text/javascript">
	...
	function fqBrand(id) {
	    if (price!==''){
			window.location.href="/search?keyword="+keyword+"&price="+price+"&brandId="+id;
		}else {
			...
			<div class="sl-b-selected J_brandSelected">
				<span class="crumbs-arrow">已选条件：</span>
					<c:forEach items="${map }" var="m">
						<a title="品牌：依琦莲（yiqilian）"  href="javascript:;" class="crumb-select-item" onclick="">
		...
		<li data-sku="1711416562" class="gl-item">
			<div class="gl-i-wrap">
				...
				<div class="p-name p-name-type-2">
					<a  title="满129立减10,199减20优惠券,支持货到付款" href="javascript:;" onclick="window.open('/product/detail?id=${product.id}')">
						<em>${product.name }</em>
					</a>
				</div>
				<div class="p-commit">
