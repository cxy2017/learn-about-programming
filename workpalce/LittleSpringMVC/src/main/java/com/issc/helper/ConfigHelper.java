...
import com.issc.ConfigConstant;
import com.issc.util.PropsUtil;
...
public class ConfigHelper {
    private static final Properties CONFIG_PROPS= PropsUtil.loadProps(ConfigConstant.PROPERTIES_FILE);
    /**
     * 获取JDBC驱动
     */
    public static String getJdbcDriver(){
        return PropsUtil.getString(CONFIG_PROPS,ConfigConstant.DRIVER_CLASS_NAME);
    }
    public static String getJdbcUrl(){
        return PropsUtil.getString(CONFIG_PROPS,ConfigConstant.URL);
    }
    public static String getJdbcUserName(){
        return PropsUtil.getString(CONFIG_PROPS,ConfigConstant.USER_NAME);
    }
     ...
     * @return 文件大小 多少字节
     */
    public static int geAppUploadLimit() {
